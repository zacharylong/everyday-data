import type { Platform } from "@/types/episode";
...
export default function ListenBar({ title, platforms }: ListenBarProps) {
  return (
    <div className="sticky top-16 z-30 bg-midnight-2/95 backdrop-blur-md border-b border-border">
      <div className="section-container py-3">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <span className="text-xs font-mono text-text-muted hidden sm:block shrink-0">
