export default function HomeCTA() {
  return (
    <section className="section-padding bg-midnight-2" aria-labelledby="cta-heading">
      <div className="section-container">
        <div className="relative rounded-2xl bg-gradient-to-br from-violet/20 via-midnight-3 to-midnight-2 border border-violet/30 overflow-hidden p-8 sm:p-12 lg:p-16 text-center violet-glow">
          {/* Background grid */}
          <div
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h2
              id="cta-heading"
              className="font-heading font-bold text-display-md text-text-primary mb-4"
            >
              Follow Everyday Data
            </h2>
            <p className="text-text-secondary text-lg mb-10 leading-relaxed">
              New episodes drop regularly. Follow or subscribe on your preferred
              platform to get notified.
            </p>
